...
# ================== COUNTRIES (طول الكود تنازلي) ==================
COUNTRIES = {
    # أمريكا الشمالية والدولية
    "+1-876": ("Jamaica", "🇯🇲"), "+1-868": ("Trinidad and Tobago", "🇹🇹"),
    "+1-809": ("Dominican Republic", "🇩🇴"), "+1-829": ("Dominican Republic", "🇩🇴"),
    "+1-849": ("Dominican Republic", "🇩🇴"), "+1-246": ("Barbados", "🇧🇧"),
    "+1-284": ("British Virgin Islands", "🇻🇬"), "+1-345": ("Cayman Islands", "🇰🇾"),
    "+1-242": ("Bahamas", "🇧🇸"), "+1-441": ("Bermuda", "🇧🇲"), "+1-767": ("Dominica", "🇩🇲"),
    "+1-473": ("Grenada", "🇬🇩"), "+1-664": ("Montserrat", "🇲🇸"), "+1-721": ("Sint Maarten", "🇸🇽"),
    "+1-758": ("Saint Lucia", "🇱🇨"), "+1-784": ("Saint Vincent and the Grenadines", "🇻🇨"),
    "+1-787": ("Puerto Rico", "🇵🇷"), "+1-939": ("Puerto Rico", "🇵🇷"), "+1": ("USA / Canada", "🇺🇸"),

    # الشرق الأوسط
    "+971": ("UAE", "🇦🇪"), "+966": ("Saudi Arabia", "🇸🇦"), "+968": ("Oman", "🇴🇲"),
    "+974": ("Qatar", "🇶🇦"), "+973": ("Bahrain", "🇧🇭"), "+965": ("Kuwait", "🇰🇼"),
    "+964": ("Iraq", "🇮🇶"), "+963": ("Syria", "🇸🇾"), "+962": ("Jordan", "🇯🇴"),
    "+961": ("Lebanon", "🇱🇧"), "+970": ("Palestine", "🇵🇸"), "+972": ("Israel", "🇮🇱"),
    "+967": ("Yemen", "🇾🇪"), "+98": ("Iran", "🇮🇷"),

    # أفريقيا
    "+212": ("Morocco", "🇲🇦"), "+213": ("Algeria", "🇩🇿"), "+216": ("Tunisia", "🇹🇳"),
    "+20": ("Egypt", "🇪🇬"), "+249": ("Sudan", "🇸🇩"), "+251": ("Ethiopia", "🇪🇹"),
    "+252": ("Somalia", "🇸🇴"), "+253": ("Djibouti", "🇩🇯"), "+254": ("Kenya", "🇰🇪"),
    "+255": ("Tanzania", "🇹🇿"), "+256": ("Uganda", "🇺🇬"), "+257": ("Burundi", "🇧🇮"),
    "+258": ("Mozambique", "🇲🇿"), "+260": ("Zambia", "🇿🇲"), "+261": ("Madagascar", "🇲🇬"),
    "+263": ("Zimbabwe", "🇿🇼"), "+264": ("Namibia", "🇳🇦"), "+27": ("South Africa", "🇿🇦"),
    "+233": ("Ghana", "🇬🇭"), "+234": ("Nigeria", "🇳🇬"),

    # أوروبا
    "+44": ("UK", "🇬🇧"), "+49": ("Germany", "🇩🇪"), "+33": ("France", "🇫🇷"),
    "+39": ("Italy", "🇮🇹"), "+34": ("Spain", "🇪🇸"), "+351": ("Portugal", "🇵🇹"),
    "+353": ("Ireland", "🇮🇪"), "+358": ("Finland", "🇫🇮"), "+370": ("Lithuania", "🇱🇹"),
    "+46": ("Sweden", "🇸🇪"), "+41": ("Switzerland", "🇨🇭"), "+380": ("Ukraine", "🇺🇦"),
    "+90": ("Turkey", "🇹🇷"), "+7": ("Russia / Kazakhstan", "🇷🇺"),

    # آسيا
    "+81": ("Japan", "🇯🇵"), "+82": ("South Korea", "🇰🇷"), "+84": ("Vietnam", "🇻🇳"),
    "+86": ("China", "🇨🇳"), "+91": ("India", "🇮🇳"), "+92": ("Pakistan", "🇵🇰"),
...
def process(text: str):
    ...
    MESSAGES.append({"text": text, "code": code, "country": country, "flag": flag})
...
function updateTop(){
  ...
  const map={}
  data.forEach(m=>{if(m.code!=="OTHER")map[m.code]=m.country+" "+m.flag})
  for(const c in map){
